...
import { faSignOutAlt, faEdit, faCircle, faBars,faTachometerAlt,faUserGraduate,faSearch,faPencilAlt,faComments,faToggleOff,faToggleOn,faPoll } from '@fortawesome/free-solid-svg-icons'
import  pigTruff from './../imgs/research/pc-truff.png'
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div>
                    <div id="res-wrap-div">
                        <span id="res-pic">
                            <img alt="timer" id="res-pc" src={pigTruff} />
                        </span>
                    </div>
                ...
                <div class="row" id="info-prov-row">
                    ...
                    <div class="col-md-6">
                        <div  class="row" id="info-prov-header">
                            <div class="col">
                                <span id="text-content-style">Savvy Pre-Med</span>
                            </div>
                        </div>
                        <p id="text-list-style" class="center-wid">
                ...
                <p id="text-content-style">
                Once I had identified the pain points for med school applicants, I was ready to start constructing the flow.                 </p>
            </div>
            <div class="col-md-1"></div>
        </div>
