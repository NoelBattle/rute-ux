...
class About extends Component {
    constructor(props) {
      ...
      this.refreshPage = this.refreshPage.bind(this);
        ...
        //  console.log('updating life cycledid')
          
       //  console.log("darkdidupdatePast"+prevProps.navCol)
        // console.log("darkdidupdateNEW"+previousState.darkmode)
  ...
  render() {
    ...
    return (
      ...
      <div class="row" id="about-content">
        ...
        url="https://www.youtube.com/watch?v=9KIOTdFXGeg"
      />
       ...
       Rute is a project I decided to embark on in order to fully understand the website creation process from start to finish.        
          ...
          <p id="text-content-style" class="center-wid">
                 ...
                 target="_blank" onClick={() => window.open("https://gist.github.com/NoelBattle/b5c47c6e63ad9c563bc852e0ace417c0", "_blank")} >Github for this Case Study
                 </Link>
                        </p>
      ...
      {/*
      <span id="footer" style={{zIndex:"9"}}>
      Copyright link to githubt
      </span>
*/}
