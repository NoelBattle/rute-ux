...
import { faUserEdit, faPencilAlt, faDollarSign, faUpload, faCalendarAlt, faLaptopCode, faHeartbeat } from '@fortawesome/free-solid-svg-icons'
...
class Favorites extends Component {
  ...
  render() {
    return (
        ...
        url="https://youtu.be/9KIOTdFXGeg?t=273"
      />
