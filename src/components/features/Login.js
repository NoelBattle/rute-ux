...
class Login extends Component {
  ...
  render() {
    return (
        ...
        class={(((this.state.navCol)=="no")&&((this.state.darkmode)=="yes"))?"comp-d-left-border":""}
            ...
            <div class="row">
                ...
                <div>
                    ...
                    Users can access the ‘/about’, ‘/directory’, and school routes without registering, but the fun begins once you log into to Rute. To improve  UX, I added a password requirement filter system so users know if their password meets the correct specifications as they type. I also added a password show/hide mask button so users can check their password input.                    </p>
                </div>
        ...
        url="https://youtu.be/9KIOTdFXGeg?t=197"
      />
