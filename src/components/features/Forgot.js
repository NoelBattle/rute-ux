...
import { faUserEdit, faPencilAlt, faDollarSign, faUpload, faCalendarAlt, faQuestion } from '@fortawesome/free-solid-svg-icons'
...
class Forgot extends Component {
  ...
  render() {
    return (
        ...
        url="https://youtu.be/9KIOTdFXGeg?t=663"
      />
               ...
               <div class="row"></div>
                ...
                <div>
          <ReactPlayer  controls={true} width="40vw"
        url="https://youtu.be/9KIOTdFXGeg?t=731"
      />
      </div>
                <p id="text-content-style">
                </p>
