                    ...
                    <div class="col-md-10">
                        <div>
                            ...
                            <p id="text-content-style">
                                A major pain point I found  in my research was the lack of a good essay planner. Since each school requires different types of essays and each of those schools has different essay prompts, staying organized is difficult.
                            </p>
                        </div>
                        <p id="text-content-style">
                            The ‘Essay Planner’ provides a place for a user to take general notes pertaining to particular essay categories. The 14 different essay categories are                   
                        </p>
                        <div class="row">
                            <div class="col">
                                <li>Why Us?</li>
                        ...
                        <p id="text-content-style">
                            Once the user is done planning, Rute creates a docx file filled with a section for each school on a users favorites, accompanied by the required essay categories, and past prompts for the category.
                        </p>
                        <p id="text-content-style">
